            ...
            <div class="jAQ" id="i-put"  style="display: none">
                ...
                <div class="jAQ">
                    <div class="aqI" id="nicescroll-iput">
                        ...
                        @include('components.input',['type'=>'disabled', 'control_id'=>'txt_sup_code', 'label'=>__("Code"), 'length'=>'5'])
                        @include('components.input',['type'=>'required', 'control_id'=>'txt_sup_name', 'label'=>__("Supplier Name"), 'length'=>'100'])
                        @include('components.input',['control_id'=>'txt_sup_website', 'label'=>__('Website'), 'length'=>'100'])
                        @include('components.input',['type'=>'required', 'control_id'=>'txt_sup_phone', 'label'=>__('Phone'), 'length'=>'15'])
                        @include('components.input',['control_id'=>'txt_sup_fax', 'label'=>__('Fax'), 'length'=>'20'])
                        @include('components.input',['type'=>'required', 'control_id'=>'txt_sup_mail', 'label'=>__('E-Mail'), 'length'=>'100'])
                    </div>
                </div>
            </div>
        </div>
