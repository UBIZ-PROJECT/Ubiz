            ...
            <div class="jAQ" id="i-put"  style="display: none">
                ...
                <div class="jAQ">
                    <div class="aqI" id="nicescroll-iput">
                        ...
                        @include('layouts/input',['control_id'=>'txt_sup_name', 'label'=>'Tên nhà cung cấp', 'length'=>'100'])
                        @include('layouts/input',['control_id'=>'txt_sup_website', 'label'=>'Website', 'length'=>'100'])
                        @include('layouts/input',['control_id'=>'txt_sup_phone', 'label'=>'Phone', 'length'=>'15'])
                        @include('layouts/input',['control_id'=>'txt_sup_fax', 'label'=>'Fax', 'length'=>'20'])
                        @include('layouts/input',['control_id'=>'txt_sup_mail', 'label'=>'Email', 'length'=>'100'])
                    </div>
                </div>
            </div>
        </div>
