...
<div class="main-content">
        ...
        <div class="r-content">
            <div class="jAQ" id="o-put">
                ...
                <div class="jAQ">
                    <p style="margin-top:10px; font-size:15px"><strong>Số lượng tồn kho:</strong> {{ $paging['rows_num'] }}</p>
                    <div class="export">
                        ...
                        <div class="yTP" role="presentation">
                            ...
                            <div class="hdG">
                                <div class="dcB col-1" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="prd_id" order-by="asc"
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">Mã Sản Phẩm</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                ...
                                <div class="dcB col-2" role="presentation">
                                    <div class="dWB" role="button" sort-name="prd_name" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">Tên Sản Phẩm</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                ...
                                <div class="dcB col-3" role="presentation">
                                    <div class="dWB" role="button" sort-name="cus_type" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">Loại Sản Phẩm</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                                        <svg class="faH asc" x="0px" y="0px" width="18px" height="18px"
                                ...
                                <div class="dcB col-4" role="presentation">
                                    <div class="dWB" role="button" sort-name="brd_name" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">Thương Hiệu</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                                        <svg class="faH asc" x="0px" y="0px" width="18px" height="18px"
                                ...
                                <div class="dcB col-5" role="presentation">
                                    <div class="dWB" role="button" sort-name="serial_no" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">Số Seri</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                                        <svg class="faH asc" x="0px" y="0px" width="18px" height="18px"
                                ...
                                <div class="dcB col-6" role="presentation">
                                    <div class="dWB" role="button">
                                        <div class="dvJ" sort-name="serial_sts" order-by=""
                                             onclick="jQuery.UbizOIWidget.w_sort(this)">
                                            <div class="tDv">Trạng thái</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                                        <svg class="faH asc" x="0px" y="0px" width="18px" height="18px"
                                ...
                                <div class="dcB col-7" role="presentation">
                                    <div class="dWB" role="button" sort-name="serial_note" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                            ...
                            <div id="table-content" class="jFr">
                                @foreach($report as $row)
                                    <div class="jvD"
                                        ...
                                        <div class="tcB col-1">
                                            <div class="cbo">
                                                <div class="nCT" title="{{$row->prd_id}}">
                                                    <span>{{$row->prd_id}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-2">
                                        ...
                                        <div class="tcB col-3">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$row->prd_type_name}}">
                                                    <span>{{$row->prd_type_name}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-4">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$row->brd_name}}">
                                        ...
                                        <div class="tcB col-5">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$row->serial_no}}">
                                        ...
                                        <div class="tcB col-6">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$row->serial_sts}}">
                                                    <span>{{$row->serial_sts}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-7">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$row->serial_note}}">
                                                    <span>{{$row->serial_note}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
