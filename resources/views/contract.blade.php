...
@section('style')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/his_order.css') }}">
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css"
          integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
@endsection
@section('headbar')
@section('search')
    @include('contract_search')
@endsection
            ...
            <div class="jAQ" id="o-put">
                        ...
                        <div class="aqK">
                            <div class="aqL">
                                <div class="GtF">
                                    ...
                                    <div class="GNi" onclick="jQuery.UbizOIWidget.w_back_to_order()">
                                        <div class="ax7 poK utooltip" title="{{ __("Back to the order page") }}">
                                            <div class="asA">
                                                <div class="arB"></div>
                                            </div>
                                        </div>
                ...
                <div class="jAQ">
                    <div class="aqH" role="presentation">
                        <div class="yTP" role="presentation">
                            ...
                            <div class="hdG">
                                <div class="dcB col-1" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ctr_no" order-by="asc"
                                ...
                                <div class="dcB col-2" role="presentation">
                                    <div class="dWB" role="button" sort-name="ctr_date" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-5" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ctr_amount_tax" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-6" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ctr_paid" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-7" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ctr_debt" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                        ...
                        <input type="hidden" id="ctr_id" name="ctr_id" value=""> {{--Nhớ đổi value--}}
                    </div>
                        ...
                        <div class="yTP">
                            <div id="table-content" class="jFr">
                                @foreach($contracts as $contract)
                                    <div class="jvD"
                                         ondblclick="jQuery.UbizOIWidget.w_go_to_input_page({{$contract->ctr_id}}, this)">
                                        <div class="tcB col-1">
                                            <div class="cbo">
                                                <div class="jgQ" onclick="jQuery.UbizOIWidget.w_c_checkbox_click(this)">
                                                    <input type="checkbox" class="ckb-i" value="{{$contract->ctr_id}}"
                                                           style="display: none"/>
                                                    <div class="asU ckb-c"></div>
                                                </div>
                                                <div class="nCT" title="{{$contract->ctr_no}}">
                                                    <span>{{$contract->ctr_no}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-2">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$contract->ctr_date}}">
                                                    <span>{{date('Y/m/d',strtotime($contract->ctr_date))}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-3">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$contract->sale_name}}">
                                                    <span>{{$contract->sale_name}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-4">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$contract->cus_name}}">
                                                    <span>{{$contract->cus_name}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-5">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$contract->ctr_amount_tax}}">
                                                    <span>{{number_format($contract->ctr_amount_tax)}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-6">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$contract->ctr_paid}}">
                                                    <span>{{number_format($contract->ctr_paid)}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-7">
                                            <div class="cbo">
                                                <div class="nCj" title="{{$contract->ctr_debt}}">
                                                    <span>{{number_format($contract->ctr_debt)}}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
