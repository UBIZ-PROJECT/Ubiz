...
@section('style')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/his_quoteprice.css') }}">
@endsection
@section('headbar')
@section('search')
    @include('his_quoteprice_search')
@endsection
            ...
            <div class="jAQ" id="o-put">
                        ...
                        <div class="aqK">
                            <div class="aqL">
                                <div class="GtF">
                                    ...
                                    <div class="GNi" onclick="jQuery.UbizOIWidget.w_back_to_quoteprices()">
                                        <div class="ax7 poK utooltip" title="{{ __("Back to the quoteprice page") }}">
                                            <div class="asA">
                                                <div class="arB"></div>
                                            </div>
                                        </div>
                ...
                <div class="jAQ">
                    <div class="aqH" role="presentation">
                        <div class="yTP" role="presentation">
                            ...
                            <div class="hdG">
                                ...
                                <div class="dcB col-7" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="qp_sale_step" order-by="">
                                        <div class="dvJ">
                        ...
                        <input type="hidden" id="qp_id" name="qp_id" value="{{ $qp_id }}">
                    </div>
                        ...
                        <div class="yTP">
                            <div id="table-content" class="jFr">
                                @foreach($quoteprices as $quoteprice)
                                    <div class="jvD"
                                         ondblclick="jQuery.UbizOIWidget.w_go_to_input_page({{$quoteprice->his_qp_id}}, this)">
                                        <div class="tcB col-1">
                                            <div class="cbo">
                                                <div class="jgQ" onclick="jQuery.UbizOIWidget.w_c_checkbox_click(this)">
                                                    <input type="checkbox" class="ckb-i" value="{{$quoteprice->his_qp_id}}"
                                                           style="display: none"/>
...
@section('end-javascript')
    <script type="text/javascript" src="{{ asset('js/his_quoteprice.js') }}"></script>
@endsection