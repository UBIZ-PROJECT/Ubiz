    ...
    <div id="search-form" class="eyo">
        <div class="hvo">
            <div class="gvo">
                <div class="rvo">
                    <span class="yvo">
                        <label for="code">Mã báo giá</label>
                    </span>
                    <span class="avo">
                        <input type="text" spellcheck="false" id="pri_code" value="" autocomplete="off">
                    </span>
                </div>
                <div class="rvo">
                    <span class="yvo">
                ...
                <div class="rvo">
                    ...
                    <span class="avo">
                        <input type="text" spellcheck="false" id="pri_date" value="" autocomplete="off">
                    </span>
                </div>
				<div class="rvo">
                    <span class="yvo">
                    ...
                    <span class="avo">
                        <input type="text" spellcheck="false" id="exp_date" value="" autocomplete="off">
                    </span>
                </div>
                <div class="rvo">
                    <span class="yvo">
