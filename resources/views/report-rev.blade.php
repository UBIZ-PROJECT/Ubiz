            ...
            <div class="jAQ" id="o-put">
                ...
                <div class="jAQ">
                    <form id="f-export">
                        <table>
                            <tr>
                                <td style="padding: 10px">@include('components.input',['control_id'=>'order_from_date', 'value'=> date('Y')."/".date('m')."/01", 'width'=> '150', 'lbl_width'=>'70', 'label'=>'Từ ngày', 'class'=>'datepicker z-pdl z-pdr', 'i_focus'=>'', 'i_blur'=>'', 'onchange'=>"qp_date_change(this)"])</td>
                                <td style="padding: 10px">@include('components.input',['control_id'=>'order_to_date', 'value'=> date('Y/m/d'), 'width'=> '150', 'lbl_width'=>'70', 'label'=>'Đến ngày', 'class'=>'datepicker z-pdl z-pdr', 'i_focus'=>'', 'i_blur'=>'', 'onchange'=>"qp_date_change(this)"])</td>
                                <td><span class="btn btn-info" id="statis-button" onclick="jQuery.UbizOIWidget.w_statis()"> Thống kê </span></td>
                            </tr>
                        </table>
                    </form>
                    <p style="margin-top:10px; font-size:15px"><strong>Số lượng đơn hàng:</strong> <span id="order_count">{{ $paging['rows_num'] }}</span></p>
                    <p style="margin-top:10px; font-size:15px"><strong>Tổng doanh thu:</strong> <span id="order_sum">{{ $report->sum }}</span> VNĐ</p>
                    <div class="export">
                        <span class="btn btn-info export" id="rev-export-button" onclick="jQuery.UbizOIWidget.w_export()"> Xuất excel </span>
                    </div>
                            ...
                            <div class="hdG">
                                ...
                                <div class="dcB col-3" role="presentation">
                                    <div class="dWB" role="button" sort-name="ord_amount_tax" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">Tổng tiền (Bao gồm thuế)</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                                        <svg class="faH asc" x="0px" y="0px" width="18px" height="18px"
