                        ...
                        <div class="aW NaT" id="rp_rep">
                            ...
                            <div class="iU">
                                <div class="wQ">
                                    ...
                                    <span class="dG">Báo cáo tồn kho</span>
                                </div>
                            </div>
                        </div>
                        <div class="aW NaT" id="rp_rev">
                            <div class="mR">
                                <div class="eT">
                                    <div class="Vf"></div>
                                    <div class="Vg">
                            ...
                            <div class="iU">
                                <div class="wQ">
                                    ...
                                    <span class="dG">Báo cáo doanh thu</span>
                                </div>
                            </div>
                        </div>
                        <div class="aW NaT" id="rp_pri">
                            <div class="mR">
                                <div class="eT">
                                    <div class="Vf"></div>
                                    <div class="Vg">
                            ...
                            <div class="iU">
                                <div class="wQ">
                                    ...
                                    <span class="dG">Báo cáo về báo giá</span>
                                </div>
                            </div>
                        </div>
                    </div>
