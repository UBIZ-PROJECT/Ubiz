...
@section('headbar')
@section('search')
    @include('layouts/products_search',["product_type"=>$product_type])
                    ...
                    <div class="aqI nicescroll" id="nicescroll-iput">
                        <div class="row z-mgl z-mgr">
                            ...
                            <div class="col-sm-3 col-md-3 col-xl-3">
                                @include('components.input',['width'=>'300','type'=>'required', 'control_id'=>'txt_seri_no', 'label'=>__("Seri Number"), 'length'=>5])
                                @include('components.input',['width'=>'300','type'=>'required', 'control_id'=>'txt_name', 'label'=>__("Name"), 'length'=>100])
                                @include('components.input',['width'=>'300','control_id'=>'txt_branch', 'label'=>__('Branch'), 'length'=>100])
                                @include('components.input',['width'=>'300','type'=>'required', 'control_id'=>'txt_model', 'label'=>__('Model'), 'length'=>15])
                                @include('components.dropdown',['control_id'=>'txt_name_type', 'label'=>__('Type'), 'data'=> Helper::convertDataToDropdownOptions($product_type, 'id', 'name_type')])
                            </div>
                            <div class="col-sm-3 col-md-3 col-xl-3 z-pdr">
                                @include('components.textarea',['width'=>'300','type'=>'required', 'control_id'=>'txt_detail', 'label'=>__('Detail'), 'length'=>100])
                            </div>
                        </div>
                    </div>
                </div>
