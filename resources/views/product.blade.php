                    ...
                    <div class="aqI nicescroll" id="nicescroll-iput">
                        <div class="row z-mgl z-mgr">
                            ...
                            <div class="col-sm-3 col-md-3 col-xl-3">
                                @include('components.input',['width'=>'500','type'=>'required', 'control_id'=>'txt_seri_no', 'label'=>__("Seri Number"), 'length'=>5])
                                @include('components.input',['width'=>'500','type'=>'required', 'control_id'=>'txt_name', 'label'=>__("Name"), 'length'=>100])
                                @include('components.input',['width'=>'500','control_id'=>'txt_branch', 'label'=>__('Branch'), 'length'=>100])
                                @include('components.input',['width'=>'500','type'=>'required', 'control_id'=>'txt_model', 'label'=>__('Model'), 'length'=>15])
                            ...
                            <div class="col-sm-3 col-md-3 col-xl-3 z-pdr">
                                @include('components.input',['width'=>'500','type'=>'required', 'control_id'=>'txt_detail', 'label'=>__('Detail'), 'length'=>100])
                            </div>
                        </div>
                    </div>
                </div>
