<div class="search">
    <div class="tyo" role="search">
        <div class="cyo">
            <input id="fuzzy" spellcheck="false" autocomplete="off" placeholder="Tìm kiếm đơn hàng" value="" type="text" onkeypress="jQuery.UbizOIWidget.w_fuzzy_search_handle_enter(event)">
        </div>
        ...
        <div class="hvo">
            <div class="gvo">
                <div class="rvo">
                    ...
                    <span class="avo">
                        <input type="text" spellcheck="false" id="ord_code" value="" autocomplete="off">
                    </span>
                </div>
                <div class="rvo">
                    <span class="yvo">
                ...
                <div class="rvo">
                    ...
                    <span class="avo">
                        <input type="text" spellcheck="false" id="ord_date" value="" autocomplete="off">
                    </span>
                </div>
                <div class="rvo">
                    <span class="yvo">
