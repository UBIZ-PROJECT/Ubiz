            ...
            <div class="jAQ" id="o-put">
                ...
                <div class="jAQ">
                    <div class="aqH" role="presentation">
                        <div class="yTP" role="presentation">
                            ...
                            <div class="hdG">
                                ...
                                <div class="dcB col-5" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ord_amount_tax" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-6" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ord_paid" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-7" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="ord_debt" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                        ...
                        <input type="hidden" id="ord_id" name="ord_id" value="{{$ord_id}}">
                    </div>
                        ...
                        <div class="yTP">
                            <div id="table-content" class="jFr">
                                @foreach($orders as $order)
                                    <div class="jvD"
                                         ondblclick="jQuery.UbizOIWidget.w_go_to_input_page({{$order->his_ord_id}}, this)">
                                        <div class="tcB col-1">
                                            <div class="cbo">
                                                <div class="jgQ" onclick="jQuery.UbizOIWidget.w_c_checkbox_click(this)">
                                                    <input type="checkbox" class="ckb-i" value="{{$order->his_ord_id}}"
                                                           style="display: none"/>
...
@section('end-javascript')
    <script type="text/javascript" src="{{ asset('js/his_order.js') }}"></script>
@endsection