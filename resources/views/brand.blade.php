                        ...
                        <div class="yTP" role="presentation">
                            ...
                            <div class="hdG">
                                <div class="dcB col-1" role="presentation">
                                    <div class="dWB dWT" role="button" sort-name="brd_id" order-by="asc" onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">{{ __('Brand No') }}</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                ...
                                <div class="dcB col-3" role="presentation">
                                    <div class="dWB" role="button" sort-name="brd_name" order-by="" onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                            <div class="tDv">{{ __('Brand Name') }}</div>
                                            <div class="mhH">
                                                <div class="acD">
                                                    <div class="huK">
                                                        <svg class="faH asc" x="0px" y="0px" width="18px" height="18px"
                    ...
                    <div class="aqB" id="nicescroll-oput">
                        <div class="yTP">
                            <div id="table-content" class="jFr">
                                <?php $index = 0; ?>
                                @foreach($data as $brd)
                                    <div class="jvD" ondblclick="jQuery.UbizOIWidget.w_go_to_input_page({{$brd->brd_id}},{{$index}})">
                                        <div class="tcB col-1">
                                            <div class="cbo">
                                                ...
                                                <div class="nCT" title="{{$brd->brd_id}}">
                                                    <span>{{$brd->brd_id}}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tcB col-2">
