...
@section('content')
            ...
            <div id="nicescroll-sidebar" class="zX">
                <nav role="navigation">
                    ...
                    <div class="sP">
                        ...
                        <div class="aW NaT" id="ds_phutung">
                            <a href="/products">
                                <div class="mR">
                                    <div class="eT">
                                        <div class="Vf"></div>
                        ...
                        <div class="aqK">
                            <div class="aqL">
                                <div class="GtF">
                                    ...
                                    <input type="file" accept="application/zip" onchange="jQuery.UbizOIWidget.w_upload_file()" name="prd_upload_file" id="prd_upload_file" style="display: none">
                                    <div class="GNi">
                                        <div class="ax7 poK">
                                            <div class="asA">
                                                <div class="asY"></div>
            ...
            <div class="jAQ" id="i-put"  style="display: none">
                ...
                <div class="product-content">
                    <div class="jAQ">
                        ...
                        <div class="aqB product-content-detail tab-content max-height-overflow-y-500">
            ...
            <div class="jAQ" id="i-put-2"  style="display: none">
                ...
                <div class="jAQ">
                    <div class="aqI nicescroll" id="nicescroll-iput-2">
                        ...
                        <div class="tb-series-container mt-4 table-scroll max-height-overflow-y-450">
    ...
    <!-- Modal -->
    <div class="modal fade" id="addSeriesModal" tabindex="-1" role="dialog" aria-labelledby="addSeriesModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addSeriesModalTitle">Thêm mới Series</h5>
