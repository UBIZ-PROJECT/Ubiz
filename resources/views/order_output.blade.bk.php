                        ...
                        <div class="yTP" role="presentation">
                            ...
                            <div class="hdG">
                                ...
                                <div class="dcB col-3" role="presentation">
                                    <div class="dWB" role="button" sort-name="ord_total_money" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-4" role="presentation">
                                    <div class="dWB" role="button" sort-name="ord_paid_money" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                                ...
                                <div class="dcB col-5" role="presentation">
                                    <div class="dWB" role="button" sort-name="ord_owed_money" order-by=""
                                         onclick="jQuery.UbizOIWidget.w_sort(this)">
                                        <div class="dvJ">
                        ...
                        <div class="yTP">
                            <div id="table-content" class="jFr">
                                @foreach($orders as $key => $order)
                                    <div class="jvD"
                                         ondblclick="jQuery.UbizOIWidget.w_go_to_input_page({{ $key + 1 }}, {{$order->id}})">
                                        <div class="tcB col-1">
                                            <div class="cbo">
                                                <div class="jgQ" onclick="jQuery.UbizOIWidget.w_c_checkbox_click(this)">
                                                    <input type="checkbox" class="ckb-i" value="{{$order->id}}"
                                                           style="display: none"/>
