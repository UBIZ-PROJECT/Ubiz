...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            var self = this, tMain1, tMain2, tPreview, tFileIcon, tClose, tCaption, tBtnDefault, tBtnLink, tBtnFileBrowse, tBtnFolderBrowse,
            ...
            tActionUpload = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">' +
                '{uploadIcon}</button>';
            tBtnFileBrowse = '<div tabindex="500" id="btnFileBrowse" class="{css}" {status}>{icon} {label}</div>';
            tBtnFolderBrowse = '<div tabindex="500" id="btnFolderBrowse" class="{css}" {status}>{icon} {label}</div>';
            ...
            self.defaults = {
                layoutTemplates: {
                    ...
                    btnLink: tBtnLink,
                    btnFileBrowse: tBtnFileBrowse,
                    btnFolderBrowse: tBtnFolderBrowse,
        ...
        _listen: function () {
            ...
            self._handler(self.$btnFile, 'click', $.proxy(self._file_browse, self));
            self._handler(self.$btnFolder, 'click', $.proxy(self._folder_browse, self));
        ...
        _renderMain: function () {
            ...
            return self.mainTemplate.setTokens({
                ...
                'fileBrowse': self._renderButton('fileBrowse'),
                'folderBrowse': self._renderButton('folderBrowse')
            });
        ...
        _renderButton: function (type) {
            ...
            switch (type) {
                ...
                case 'upload':
                    ...
                    break;
                case 'fileBrowse':
                    tmplt = self._getLayoutTemplate('btnFileBrowse');
                    break;
                case 'folderBrowse':
                    tmplt = self._getLayoutTemplate('btnFolderBrowse');
                    break;
                default:
                    return '';
            }

            css += (type === 'fileBrowse' || type === 'folderBrowse') ? ' btn-file' : ' fileinput-' + type + ' fileinput-' + type + '-button';
            if (!$h.isEmpty(label)) {
    ...
    $.fn.fileinputLocales.en = {
        fileSingle: 'file',
        filePlural: 'files',
        fileBrowseLabel: 'Browse &hellip;',
        folderBrowseLabel: 'Browse &hellip;',
        removeLabel: 'Remove',
